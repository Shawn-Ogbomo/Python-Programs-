...
print("The minimum value in this list is:",f"{min(list_of_numbers_from_one_to_50)}.")
print("The maximum value im this list is:",f"{max(list_of_numbers_from_one_to_50)}.")
print("The sum of the values in this list is:",f"{sum(list_of_numbers_from_one_to_50)}.")